...
def main(args):
    ...
    # ---------- Reviewing Data for CAD ---------------
    # Sequence Length are the number of beats in the score.
    # Every point in the sequence consists of concatenation of model predictions
    # with vec = max notes with onset within two given beats.
