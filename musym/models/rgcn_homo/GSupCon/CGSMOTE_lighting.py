...
from musym.models.rgcn_homo.GSupCon.models import ContrastiveGraphSMOTE
...
class CGSMOTELightning(LightningModule):
    def __init__(self,
                 in_feats,
                 n_hidden,
                 n_classes,
        ...
        super(CGSMOTELightning, self).__init__()
        self.save_hyperparameters()
        self.loss_weight = loss_weight
        self.module = ContrastiveGraphSMOTE(in_feats, n_hidden, n_classes, n_layers, activation, dropout)
        self.lr = lr
...
if __name__ == '__main__':
    ...
    model = CGSMOTELightning.load_from_checkpoint(
