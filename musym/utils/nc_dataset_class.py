...
class cad_local_wtc(CadHomoGraphDataset):
	def __init__(self, add_inverse_edges=False, add_aug=False, select_piece=None, save_path=None):
		...
		super().__init__(
			...
			add_inverse_edges=add_inverse_edges, add_aug=add_aug,
			select_piece=select_piece, normalize=False,
			features=["onset", "duration", "ts"] + BASIS_FN + NOTE_FEATURES, save_path=save_path,
			piece_list=BACH_FUGUES, pos_enc_dim=20)
...
class cad_algo_wtc(CadHomoGraphDataset):
	def __init__(self, add_inverse_edges=False, add_aug=False, select_piece=None, save_path=None):
		...
		super().__init__(
			...
			add_inverse_edges=add_inverse_edges, add_aug=add_aug,
			select_piece=select_piece, normalize=False,
			features=CAD_FEATURES, save_path=save_path,
			piece_list=BACH_FUGUES, pos_enc_dim=0)
...
class cad_algo_msq(CadHomoGraphDataset):
	def __init__(self, add_inverse_edges=False, add_aug=False, select_piece=None, save_path=None):
		...
		super().__init__(
			...
			select_piece=select_piece, normalize=False,
			features=CAD_FEATURES, save_path=save_path,
			piece_list=MOZART_STRING_QUARTETS, pos_enc_dim=0)
...
class cad_algo_hsq(CadHomoGraphDataset):
	def __init__(self, add_inverse_edges=False, add_aug=False, select_piece=None, save_path=None):
		...
		super().__init__(
			...
			select_piece=select_piece, normalize=False,
			features=CAD_FEATURES, save_path=save_path,
			piece_list=HAYDN_STRING_QUARTETS, pos_enc_dim=0)
...
class cad_algo_quartets(CadHomoGraphDataset):
	def __init__(self, add_inverse_edges=False, add_aug=False, select_piece=None, save_path=None):
		...
		super().__init__(
			...
			select_piece=select_piece, normalize=False,
			features=CAD_FEATURES, save_path=save_path,
			piece_list=QUARTETS, pos_enc_dim=0)
